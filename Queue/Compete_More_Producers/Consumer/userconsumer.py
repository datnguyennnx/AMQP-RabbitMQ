...
#Declare a queue
queue = channel.queue_declare(queue='user', exclusive= True)
...
def callback(ch, method, properties, body):
    ...
    print(f" [x] User received {body}")        

# We need to tell RabbitMQ that this particular callback function should receive messages from our user queue
